...
- (instancetype)init {
    ...
    if (self) {
        ...
        [self loadPrivateKeyFromFile: privateKeyPath password:@"123456"];    // 这里，请换成你生成p12时的密码
    }
    return self;
}
...
- (SecKeyRef)getPrivateKeyRefrenceFromData:(NSData*)p12Data
...
- (NSString*)rsaEncryptString:(NSString*)string {
    ...
    NSString* base64EncryptedString = [encryptedData vb_base64EncodedString];
